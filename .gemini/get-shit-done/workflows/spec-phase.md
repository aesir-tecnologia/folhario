...
```bash
INIT=$(node "/Users/machado/Projects/folhario/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/machado/Projects/folhario/.gemini/get-shit-done/templates/spec.md.
