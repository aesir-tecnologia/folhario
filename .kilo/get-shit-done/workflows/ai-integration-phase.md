...
<required_reading>
@/Users/machado/Projects/folhario/.kilo/get-shit-done/references/ai-frameworks.md
@/Users/machado/Projects/folhario/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/machado/Projects/folhario/.kilo/agents/gsd-framework-selector.md for instructions.
...
```bash
cp "/Users/machado/Projects/folhario/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/machado/Projects/folhario/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/machado/Projects/folhario/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/machado/Projects/folhario/.kilo/agents/gsd-eval-planner.md for instructions.
