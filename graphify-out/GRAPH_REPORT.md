...
- Large corpus: 471 files · ~255,640 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary

- 1299 nodes · 1801 edges · 257 communities (241 shown, 16 thin omitted)
...
- [[_COMMUNITY_Inline Edit Field Tests|Inline Edit Field Tests]]
- [[_COMMUNITY_Locations API|Locations API]]
...
- [[_COMMUNITY_Online Status Hook|Online Status Hook]]
- [[_COMMUNITY_Offline Theme Variants|Offline Theme Variants]]
- [[_COMMUNITY_No-Drizzle-in-Routes Lint|No-Drizzle-in-Routes Lint]]
- [[_COMMUNITY_Diagnostics Consent E2E|Diagnostics Consent E2E]]
- [[_COMMUNITY_Email Sending Functions|Email Sending Functions]]
- [[_COMMUNITY_Security & robots.txt|Security & robots.txt]]
...
## Communities (257 total, 16 thin omitted)
...
Cohesion: 0.09
Nodes (13): c(), d(), e\_, ei, en, eo, ex, f (+5 more)
...
Cohesion: 0.15
Nodes (13): toPhotoEntrySnakeCase(), toPlantSnakeCase(), toPlantWithSignedUrlSnakeCase(), NotFound(), getPlant(), listPhotoEntries(), DiagLayout(), signCatalogPhotoUrl() (+5 more)

### Community 13 - "API Pagination & Hashing"

Cohesion: 0.19
Nodes (13): getHandler(), postHandler(), decodeCursor(), decodeSortCursor(), encodeCursor(), encodeSortCursor(), normalizeLimit(), computeMultipartRequestHash() (+5 more)
...
Cohesion: 0.17
Nodes (14): requireApiUser(), adapter(), getCurrentUser(), getCurrentUserFromSession(), completeOauthSignup(), resendVerification(), updateMyTimezone(), POST() (+6 more)

### Community 17 - "Feature Flags & Endpoints"

Cohesion: 0.15
Nodes (12): errorResponse(), upsertVerifiedTestUser(), isEnabled(), POST(), GET(), POST(), POST(), isEnabled() (+4 more)
...
Cohesion: 0.17
Nodes (9): AppShell(), AppLayout(), getCurrentUserFromSessionReadOnly(), resolveSubscriptionState(), SubscriptionProvider(), CatalogPage(), CatalogEmpty(), PublicLayout() (+1 more)
...
Cohesion: 0.34
Nodes (10): requireVerifiedUser(), withIdempotency(), GET(), POST(), deletePhotoEntryHandler(), deletePlantHandler(), errorStatusFor(), parseCookieValue() (+2 more)
...
Cohesion: 0.14
Nodes (3): PlantCard(), useSortPreference(), SkeletonGroup()
...
Cohesion: 0.2
Nodes (4): QueryProvider(), shouldPersist(), checkAndEvict(), getStorageUsageRatio()
...
Cohesion: 0.2
Nodes (10): Alt Text Rules for User Photos, Color Not Sole Signal Principle, PWA Manifest (Installable, Standalone), prefers-reduced-motion Support, Accessibility & Responsiveness Spec, 44x44px Min Touch Targets, Color Palette (Canopy Green, Terracotta, Trust Teal, etc.), Dark Mode (Light + Dark Variants) (+2 more)
...
Cohesion: 0.25
Nodes (4): ComboboxTestHarness(), ComboboxTestPage(), LocationCombobox(), norm()
...
### Community 45 - "Bottom Sheet Component Tests"

Cohesion: 0.29
Nodes (3): BottomSheetTestHarness(), BottomSheetTestPage(), BottomSheet()
...
- **Why does `eq` connect `Async Jobs & Inngest` to `SW Cache Engine`, `Photo Entry & Storage Paths`, `IAM Application Layer`, `Auth Middleware & Rate Limiting`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `deletePhotoEntry()` connect `Photo Entry & Storage Paths` to `Storage Adapter Layer`, `Async Jobs & Inngest`, `Auth Middleware & Idempotency`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `useSubscription()` connect `Subscription & Error Types` to `Plant Profile Mutation Tests`, `Add Plant Form Tests`, `App Shell Components`, `App Shell & Layouts`, `Catalog Grid & Sorting`, `Add Plant Form`?**
