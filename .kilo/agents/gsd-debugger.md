...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/machado/Projects/folhario/.kilo
                  → checks /Users/machado/Projects/folhario/.kilo/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/machado/Projects/folhario/.kilo/get-shit-done
                  → writes to /Users/machado/Projects/folhario/.kilo/get-shit-done/hooks/
...
@/Users/machado/Projects/folhario/.kilo/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/machado/Projects/folhario/.kilo/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/machado/Projects/folhario/.kilo/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/machado/Projects/folhario/.kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/machado/Projects/folhario/.kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
