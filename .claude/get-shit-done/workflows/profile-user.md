...
```bash
cp "/Users/machado/Projects/folhario/.claude/get-shit-done/USER-PROFILE.md" "/Users/machado/Projects/folhario/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/machado/Projects/folhario/.claude/USER-PROFILE.backup.md"
```
