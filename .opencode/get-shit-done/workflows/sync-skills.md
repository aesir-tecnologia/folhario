...
INSTALL_JS_GLOBAL="/Users/machado/Projects/folhario/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/machado/Projects/folhario/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
