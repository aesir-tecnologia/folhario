...
- **Global scope**: `/Users/machado/Projects/folhario/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/machado/Projects/folhario/.gemini/notes/`)
...
2. Glob `/Users/machado/Projects/folhario/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/machado/Projects/folhario/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/machado/Projects/folhario/.gemini/notes/` — works in any directory
