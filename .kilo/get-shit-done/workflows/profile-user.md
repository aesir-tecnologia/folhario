...
- @/Users/machado/Projects/folhario/.kilo/agents/gsd-user-profiler.md (profiler agent definition)
...
```bash
cp "/Users/machado/Projects/folhario/.kilo/get-shit-done/USER-PROFILE.md" "/Users/machado/Projects/folhario/.kilo/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/machado/Projects/folhario/.kilo/USER-PROFILE.backup.md"
```
