...
```
No project skills found. Add skills to any of: `.kilo/skills/`, `.kilo/skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file.
```

**Discovery behavior:**

- Scans `.kilo/skills/`, `.kilo/skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
