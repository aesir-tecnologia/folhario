...
```bash
AUDITOR_MODEL=$(node "/Users/machado/Projects/folhario/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/machado/Projects/folhario/.claude/agents/gsd-eval-auditor.md for instructions.
