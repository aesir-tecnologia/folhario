...
```bash
INIT=$(node "/Users/machado/Projects/folhario/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/machado/Projects/folhario/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
